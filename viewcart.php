...
<html lang="en">
	...
	<body>
		...
		<div class="container p-0 a_viewcart">
			<div class="row m-0 mb-4">
				<div class="col-md-8 p-0">
					<div class="bg-white shadow-sm cart_cont">
						<div class="clearfix cart_header border border-top-0 border-left-0 border-right-0 p-2">
							<h5 class="float-left">MY CART (0)</h5>
							<form class="float-right cart_pin_search position-relative ">
								<i class="fa fa-map-marker"></i>
								<input class="border-0 ml-2 cart_pincode" placeholder="Enter Delivery Pincode" type="text" size="14" maxlength="6">
								<div class="border shadow-sm position-absolute bg-white">
									<div class="border border-left-0 border-right-0  border-top-0 h-50 p-2">From Saved Addresses</div>
									<div class="p-2">
										<a href="#">Login</a> to see your saved addresses
									</div>
								</div>
								<input type="submit" name="check" value="Check" class="btn btn-link">
							</form>
						</div>
						<div class="cart_body">
								...
								<div class="col-md-2 pt-4 pb-4 pr-0">
									...
									<div class="row m-0">
										<div class="col-md-3 p-0">
											<a href="#" class="btn disabled cartButton d-inline-block border rounded-circle text-center text-dark minus">-</a>
										</div>
										<div class="col-md-6 p-0">
											<input type="text" class="w-75 pl-3 ml-2" value="1" min="1" max="100">
										</div>
										<div class="col-md-3 p-0">
											<a href="#" class="btn cartButton d-inline-block border rounded-circle text-center text-dark plus">+</a>
										</div>
									</div>
								</div>
						...
						<div class="cart_footer shodow clearfix">
							<div class="float-right m-3">
								<a href="#" class="btn btn-lg border shadow-sm rounded-0 mr-2"> <i class="fa fa-chevron-left mr-1"></i> CONTINUE SHOPPING</a>
								<a href="#" class="btn btn-lg a_bg_orange text-white wht rounded-0"> PLACE ORDER</a>
							</div>					
						</div>
					</div>				
				</div>
				<div class="col-md-4">
					<div class="a_viewcart_card card">
			...
			<div class="row m-0 mb-4">
				<div class="col-md-12 p-0">
					<div class="bg-white shadow-sm cart_cont">
						...
						<div class="cart_body">							
							<div class="emptyCartBox text-center">
								<img class="img-fluid" src="img/cart/empty_cart.png">
								<div class="text-secondary mb-4">Your Shopping Cart is empty</div>
							</div>
						</div>
					</div>				
				</div>
		...
		<script>
			...
			*/
			...
			$(document).ready(function($){ //jQuery Start
				...
				$(document).on('click','.cart_body a',function(e){
					e.preventDefault();
				});
				
				$(document).on('click','.cart_body .plus',function(){
					overlay();
					var x = $(this).closest('.row').find('input[type=text]').val();
					//alert(x);
					//int <- string
					x = parseInt(x);
					x +=1;
					$(this).closest('.row').find('input[type=text]').val(x);
					
					if(x > 1){
						$('.minus').removeClass('disabled');
					}
				});
				$(document).on('click','.cart_body .minus',function(){
					overlay();
					var x = $(this).closest('.row').find('input[type=text]').val();
					//alert(x);
					//int <- string
			...
			$(window).on('scroll', function(event) {
				...
				//,.a_viewcart_card
				if (scrollValue > 46) {
					$('.a_viewcart_card').addClass('affix2');
				}else{
					$('.a_viewcart_card').removeClass('affix2');
				} 
			});
