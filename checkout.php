		...
		<div class="container mt-3 p-0 a_viewcart a_checkoutcont">
			<div class="row m-0 mb-4">
				<div class="col-md-8 p-0">
					...
					<div class="shadow-sm mb-2 a_diliver">
						<a class="btn bg-primary btn-link btn-block rounded-0 text-left  text1" data-toggle="collapse" href="#collapseExample2" role="button" aria-expanded="false" aria-controls="collapseExample">
							<span class="badge badge-light mr-2 text-primary a51">2</span > DELIVERY ADDRESS
						</a>
					...
					<div class="shadow-sm mb-2 a_diliver">
						<a class="btn bg-primary btn-link btn-block rounded-0 text-left  text1" data-toggle="collapse" href="#collapseExample3" role="button" aria-expanded="false" aria-controls="collapseExample">
							<span class="badge badge-light mr-2 text-primary">3</span> ORDER SUMMARY
						</a>
						<div class="collapse bg-white checkout_box a_diliver" id="collapseExample3">
					...
					<div class="shadow-sm mb-2 a_dili">
						<a class="btn bg-primary btn-link btn-block rounded-0 text-left text1 " data-toggle="collapse" href="#collapseExample4" role="button" aria-expanded="false" aria-controls="collapseExample">
