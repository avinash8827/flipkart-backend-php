...
<html lang="en">
	...
	<body>
		...
		<div class="bg-white a_product_reviews">
			<div class="row">
				<div class="col-md-3 p-0 h-100 border border-bottom-0 border-left-0 border-top-0">
					<aside>
						<a href="#" class="p-3 d-block">
							<div class="prod_img pt-4 pb-4">
								<img class="img-fluid" src="img/product_reviews/product.jpeg">
							</div>
							<div class="text-secondary">REEBOK</div>
							<div>REEBOK FUSION XREAME ss 19SS...</div>
							<img src="">
						</a>
						<div class="a_detail_rating_reviewbox p-4">
							<div><strong>User Images</strong></div>
							<div class=" clearfix">
								<a href="#">
				...
				<div class="col-md-9 p-0">
					<section class="bg-white">
						<div class="clearfix border border-left-0 border-right-0 border-top-0 pt-4 pb-4">
							<h4 class="float-left mr-2">All Reviews for REEBOK RUN FUSION XTREME SS 19 Running Shoes For Men</h4>
							<select class=" border btn btn-outline-secondaryfloat-right">
