						...
						<form class="ac_personal mb-3">
							<div class="account_box">
								<div class="mb-5">
									...
									<div class="row w-75 mb-3 a_custmor">
										<div class="col-md-5 a_flipkart">
								...
								<div class="mb-5">
									...
									<div class="row w-25 mb-3 a_gender">
										<div class="col">
											<label>
							...
							<div class="account_box">
								<div class="mb-5">
									...
									<div class="row w-75 mb-3 a_pass">
										<div class="col-md-6 ">
							...
							<div class="account_box">
								<div class="mb-5">
									<div class="mb-3 a_pass">
										<span class="lead">Mobile Number</span> <a class="ml-4 ac_edit a_pass" href="#">Edit</a>
									</div>
									<div class="row w-75 mb-3 a_pass ">
										<div class="col-md-6">
